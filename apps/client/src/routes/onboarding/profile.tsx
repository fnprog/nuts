  ...
  return (
    ...
    >
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">First, a bit about you</h1>
        <p className="text-muted-foreground leading-relaxed">
          Tell us who you are and where you're at in your journey.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select value={currency} onValueChange={setCurrency}>
             <SelectTrigger id="currency" className="h-12 text-lg rounded-xl">
          ...
          <p className="text-[10px] text-muted-foreground/60 px-1 italic">(detected from your location)</p>
        </div>
                ...
                >
                   ...
                   <div className="flex flex-col gap-0.5">
                      <span className={cn(
                        ...
                        financialStage === stage.id ? "text-primary" : "text-foreground"
                      )}>
                        {stage.title}
                      </span>
      ...
      <div className="pt-6">
        <Button 
          size="lg" 
          onClick={handleNext} 
          disabled={!name || !financialStage}
          className="w-full gap-2 h-14 text-lg rounded-xl"
        >
          Next
