...
export function NestedCategorySelect({ categories, value, onValueChange, placeholder = "Select a category" }: CategorySelectProps) {
          ...
          {selectedInfo ? (
            <div className="flex items-center gap-2 truncate">
              ...
              <span className="truncate">
                {selectedInfo.subcategoryName ? `${selectedInfo.mainCategoryName} / ${selectedInfo.subcategoryName}` : selectedInfo.mainCategoryName}
              </span>
            </div>
          ) : (
