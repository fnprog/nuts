...
export function PageLoader() {
  return (
    <div className="flex min-h-[400px] items-center justify-center" role="status" aria-live="polite" aria-label="Loading page content">
...
export function TableLoader() {
  return (
    <div className="space-y-3" role="status" aria-live="polite" aria-label="Loading table data">
...
export function CardLoader() {
  return (
    <div className="space-y-4 rounded-lg border p-6" role="status" aria-live="polite" aria-label="Loading card content">
      <div className="space-y-2">
...
export function InlineLoader({ text = "Loading..." }: { text?: string }) {
  return (
    <div className="flex items-center space-x-2 p-2" role="status" aria-live="polite" aria-label={text}>
      <div className="border-primary h-4 w-4 animate-spin rounded-full border-2 border-t-transparent" aria-hidden="true" />
...
export function SidebarLoader() {
  return (
    <div className="space-y-4 p-4" role="status" aria-live="polite" aria-label="Loading navigation">
...
export function LazyLoadingWrapper({ children, fallback, error }: { children: React.ReactNode; fallback?: React.ReactNode; error?: React.ReactNode }) {
  return (
    <div className="flex min-h-[200px] items-center justify-center">
      {error ? (
        <div className="p-4 text-center" role="alert" aria-live="assertive">
