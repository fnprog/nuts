  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-card fixed inset-0 top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-xl border p-6 shadow-xl duration-200 sm:max-w-lg",
  ...
  return (
    <DialogPortal data-slot="sub-dialog-portal">
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background fixed top-[50%] left-[50%] z-[60] grid w-full max-w-lg gap-4 rounded-lg border p-6 shadow-xl duration-200",
          isClosingByDrag
