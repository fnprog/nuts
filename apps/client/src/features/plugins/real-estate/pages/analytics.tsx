          ...
          <CardContent className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={projectionData}>
                ...
                <Tooltip formatter={currencyFormatter} />
                <Legend />
                <Area type="monotone" dataKey="equity" stackId="1" stroke="#10B981" fill="#10B981" name="Equity" />
                <Area type="monotone" dataKey="debt" stackId="1" stroke="#EF4444" fill="#EF4444" name="Debt" />
              </AreaChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={cashFlowData}>
                ...
                <Line type="monotone" dataKey="cashFlow" stroke="#8884d8" name="Net Cash Flow" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
