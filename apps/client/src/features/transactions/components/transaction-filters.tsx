...
export function TransactionFilters({ filters, onFiltersChange, onClearAll }: TransactionFiltersProps) {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          />
          {filters.type && (
            <Button variant="ghost" size="sm" onClick={() => removeFilter("type")} className="h-6 px-2 text-xs">
        ...
        <div className="space-y-2">
          ...
          />
          {filters.account_id && (
            <Button variant="ghost" size="sm" onClick={() => removeFilter("account_id")} className="h-6 px-2 text-xs">
              <X className="mr-1 h-3 w-3" />
              Remove
            </Button>
          )}
        ...
        <div className="space-y-2">
          ...
          />
          {filters.category_id && (
            <Button variant="ghost" size="sm" onClick={() => removeFilter("category_id")} className="h-6 px-2 text-xs">
              <X className="mr-1 h-3 w-3" />
              Remove
            </Button>
          )}
        ...
        <div className="space-y-2">
          ...
          />
          {filters.currency && (
            <Button variant="ghost" size="sm" onClick={() => removeFilter("currency")} className="h-6 px-2 text-xs">
              <X className="mr-1 h-3 w-3" />
              Remove
            </Button>
          )}
