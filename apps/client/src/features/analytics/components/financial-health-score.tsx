    ...
    <div className="flex flex-col items-center justify-center">
      <div className="relative h-48 w-48">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <motion.div className="text-4xl font-bold" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 0.5 }}>
            {score}
          </motion.div>
          <motion.div
      ...
      <div className="mt-8 grid grid-cols-2 gap-x-8 gap-y-4 text-center">
        <div>
          <div className="text-muted-foreground text-sm">Debt Ratio</div>
        ...
        <div>
          <div className="text-muted-foreground text-sm">Savings Rate</div>
        ...
        <div>
          <div className="text-muted-foreground text-sm">Emergency Fund</div>
