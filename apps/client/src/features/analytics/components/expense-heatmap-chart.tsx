  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 80 }}>
        ...
        <YAxis type="category" dataKey="category" name="Category" allowDuplicatedCategory={false} width={80} tick={{ fontSize: 12 }} />
        <Tooltip
          cursor={{ strokeDasharray: "3 3" }}
          formatter={(_value, _name, props) => [`$${props.payload.z}`, `${props.payload.category} (${props.payload.day})`]}
          contentStyle={{
