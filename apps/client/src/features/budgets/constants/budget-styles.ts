...
export const BUDGET_STYLE_OPTIONS: BudgetStyleOption[] = [
  {
    ...
    pros: ["Detailed control per category", "Clear spending limits", "Easy to track overspending", "Great for planning ahead"],
    cons: ["Requires regular maintenance", "Less flexibility between categories", "Can feel restrictive"],
    icon: "LayoutList",
  ...
  },
  {
    ...
    pros: ["Maximum flexibility", "Less mental overhead", "Adapts to changing needs", "Simple to maintain"],
    cons: ["Less granular control", "Harder to identify problem areas", "May lead to overspending in some areas"],
    icon: "Droplets",
  ...
  },
  {
    ...
    pros: ["Extremely simple", "No category management", "Quick to set up", "Low maintenance"],
    cons: ["No category insights", "Limited visibility into spending patterns", "Harder to optimize"],
    icon: "Target",
  ...
  },
  {
    ...
    pros: ["Complete money control", "Forces intentional spending", "No money left unassigned", "Builds financial discipline"],
    cons: ["Time-intensive setup", "Requires regular updates", "Can feel overwhelming at first"],
    icon: "Calculator",
  ...
  },
  {
    ...
    pros: ["Proven frameworks", "Automatic calculations", "Scales with income", "Easy to understand"],
    cons: ["Less customization", "May not fit unique situations", "Requires income tracking"],
    icon: "PieChart",
