...
const BUNDLE_ID = "com.nuts.finance"; // ios bundle id
const PACKAGE = "com.nuts.finance"; // android package name
const NAME = "NutsFinance"; // app name
const EXPO_ACCOUNT_OWNER = "fantasypg"; // expo account owner
const EAS_PROJECT_ID = "18f2bffa-55d5-4bab-a27c-b00904e1cd56"; // eas project id
